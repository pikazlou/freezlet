...
var dicts = {
    ...
    'sekmes-10-advanced': {
        ...
        'Take (imperative) trolleybus number 19': '(Važiuok|Važiuokite) devynioliktu (19) troleibusu.',
        'Will you get off at the next stop?': 'Ar [jūs] (lipsite|išlipsite) kitoje stotelėje?',
        '(in a bus) I would like to get off': 'Norėčiau išlipti',
        ...
        'I go to the shop by car': 'Į parduotuvę [aš] važiuoju mašina/[Aš] važiuoju į parduotuvę mašina',
        ...
        'Please show student ID': 'Prašom parodyti studento pažymėjimą',
    },
    'sekmes-11-basic': {
